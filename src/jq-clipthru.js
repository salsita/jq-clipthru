...
(function() {
  $.fn.clipthru = function(options) {
    var addIdToBlocks, allBlocks, allClones, attachListeners, clipOverlayClone, clipOverlayOriginal, collidingBlocks, createOverlayClones, defaults, getAllBlocks, getCollidingBlocks, getCollisionArea, getOtherCollision, getOverlayOffset, init, overlay, overlayCloneTarget, overlayOffset, refresh, settings, updateOverlayClones;
    defaults = {
      method: 'css',
      simpleMode: false,
      blockSource: false,
