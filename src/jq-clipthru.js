    ...
    return $.widget("salsita.clipthru", {
      ...
      _manageOriginMask: function() {
          ...
          if (_self.collidingBlocks.length > 0) {
            ...
            for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
              ...
              if (_self.collidingBlocks.hasOwnProperty(i)) {
                collisionMask = collisionMask + "<rect                   x='10'                   y='10'                   width='100'                   height='100'                   fill='black'/>";
              }
            }
            maskTemplate = $("<svg id='" + _self.options.dataAttribute + "-origin-mask-wrapper' height='0' style='position: absolute; z-index: -1;'>                              <defs>                                <mask id='" + _self.options.dataAttribute + "-origin-mask' maskUnits='userSpaceOnUse'>                                  <rect id='" + _self.options.dataAttribute + "-origin-mask-fill' x='0' y='0' width='242' height='242' fill='white' />                                  " + collisionMask + "                                </mask>                              </defs>                            </svg>");
        ...
        if (this.svgMaskInitialized) {
          ...
          manageSVGObject();
          this.element.on("collisionStart." + _self.options.dataAttribute + " collisionEnd." + _self.options.dataAttribute, function(e, el) {
            return manageSVGObject();
          });
          this.svgMaskInitialized = true;
          return this._manageOriginMask();
        }
      },
